    ...
    <div>
      ...
      {erro && !carregando && (
        <div style={{ ...boxStyle, borderColor: "rgba(220,38,38,0.4)" }}>
          ...
          <div style={{ fontSize: 12, color: dark ? "#9ca3af" : "#6b7280", marginBottom: 12 }}>
            {erro} — a API de Dados Abertos pode estar indisponível ou o navegador pode ter bloqueado as requisições (CORS).
          </div>
